...
pub const Data = extern struct {
	...
	pub fn simple(self: *Self, conv: Converter, chans: u32) !void {
...
pub const State = opaque {
	...
	pub fn new(conv: Converter, chans: u32) !*State {
	...
	pub fn setRatio(self: *Self, new_ratio: f64) !void {
	...
	pub fn getChannels(self: *Self) !void {
		const result = src_get_channels(self);
		return if (result >= 0) {} else toError(result);
	}
...
pub fn strError(err: anyerror) ?[:0]const u8 {
